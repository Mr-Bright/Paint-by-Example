    ...
    with torch.no_grad():
        with precision_scope("cuda"):
            with model.ema_scope():
                ...
                inpaint_image = Image.open(opt.inpaint_img_path).convert("RGB")
                inpaint_image = get_tensor()(inpaint_image).unsqueeze(0)
                ...
                ###################################################################
                # 将inpain_mask和inpaint_image传入, inpaint_mask是resize过的
